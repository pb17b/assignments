...
n=day(t);
% %%%%%%%%%%%%
cpcnwfl(cpcnwfl==-999000000)=0;
cpcswfl(cpcswfl==-999000000)=0;
cpcsrvr(cpcsrvr==-999000000)=0;
cpcstjrvr(cpcstjrvr==-999000000)=0;
cpcsfl(cpcsfl==-999000000)=0;
nwfl=[y' m' n' cpcnwfl];
swfl=[y' m' n' cpcswfl];
srvr=[y' m' n' cpcsrvr];
sfl=[y' m' n' cpcsfl];
stjrvr=[y' m' n' cpcstjrvr];
