...
'open /home/pbeasley/heat/RSM/firstlast/test-date-URSM20-HI13.ctl'
'define first=ave(hi13f,time=12z01jan1986,time=12z01jan2005)'
'define last=ave(hi13l,time=12z01jan1986,time=12z01jan2005)'

'open /home/pbeasley/heat/RSM/firstlast/test-date-URSM21-HI13.ctl'
...
'define varfavg=(sum(pow(hi13f.2-first2,2),time=12z01jan2041,time=12z01jan2060)+sum(pow(hi13f-first,2),time=12z01jan1986,time=12z01jan2005))/(20+20-2)'
'define tdiff=diff1/(sqrt(varfavg*(1/20+1/20)))'

'define varlavg=(sum(pow(hi13l.2-last2,2),time=12z01jan2041,time=12z01jan2060)+sum(pow(hi13l-last,2),time=12z01jan1986,time=12z01jan2005))/(20+20-2)'
...
'gxprint firstdate13-URSM.eps'
*res needs to be fit for portrait mode
'gxprint firstdate-URSM-HI13.png x850 y1100'
'c'
...
*'xcbar 8.05 8.15 0.9 10.8 -fw 0.09 -fh 0.1 -line on -dir v -edge triangle'
'xcbar 4.75 4.9 1.6 10.5 -fw 0.09 -fh 0.1 -line on -dir v -edge triangle'
'gxprint lastdate13-URSM.eps'
*res needs to be fit for portrait mode
'gxprint lastdate-URSM-HI13.png x850 y1100'
