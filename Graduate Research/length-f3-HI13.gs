...
'define varfavg=(sum(pow(f3.2-one2,2),time=12z01jan2041,time=12z01jan2060)+sum(pow(f3-one,2),time=12z01jan1986,time=12z01jan2005))/(20+20-2)'
'define tdiff=diff1/(sqrt(varfavg*(1/20+1/20)))'

'define varlavg=(sum(pow(f3.4-one4,2),time=12z01jan2041,time=12z01jan2060)+sum(pow(f3.3-one3,2),time=12z01jan1986,time=12z01jan2005))/(20+20-2)'
